...
def callback(data):
    ...
    marker = Marker()
    marker.header.frame_id = "ibeo_lux_201_link"
    ...
    if len(pedestrians) > 0:
        for element in range(len(pedestrians)):
            ...
            cluster = Marker()
            cluster.ns = "cluster"
            cluster.header.frame_id = "ibeo_lux_201_link"
            ...
            arrow = Marker()
            arrow.ns = "arrow"
            arrow.header.frame_id = "ibeo_lux_201_link"
            ...
            point2 = Point()
            point2.x = point.x + pedestrians[element].direction.x
            point2.y = point.y + pedestrians[element].direction.y
            point2.z = point.z
